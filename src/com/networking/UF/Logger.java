...
public class Logger {
	...
	private  void writeToLogFile(String message) {
		...
		String messageWithTimestamp = System.getProperty("line.separator") + System.getProperty("line.separator") + "[" + dateFormat.format(currentTime) + "]: " + message + ".";
		try {
	 ...
	 * @param peerTwoId
	 */
	public  void logTCPCreationEvent(Integer peerTwoId, String direction) {
		String message = "";
	 ...
	 * @return String
	 */
	private  String stringifyPreferredNeighbors(List<Integer> preferredNeighborIds) {
	 ...
	 * @param preferredNeighborIds
	 */
	public  void logChangeOfPreferredNeighbors(List<Integer> preferredNeighborIds) {
	 ...
	 */
	public  void logChangeOfOptimisticallyUnchokedNeighbor(Integer optimisticallyUnchokedNeighborId) {
	 ...
	 * @param peerTwoId
	 */
	public  void logUnchokingEvent(Integer peerTwoId) {
	 ...
	 * @param peerTwoId
	 */
	public  void logChokingEvent(Integer peerTwoId) {
	 ...
	 * @param pieceIndex
	 */
	public  void logReceiptOfHaveMessage(Integer peerTwoId, Integer pieceIndex) {
	 ...
	 * @param peerTwoId
	 */
	public  void logReceiptOfInterestedMessage(Integer peerTwoId) {
	 ...
	 * @param peerTwoId
	 */
	public  void logReceiptOfNotInterestedMessage(Integer peerTwoId) {
	 ...
	 */
	public  void logPieceFullyDownloaded(Integer peerTwoId, Integer pieceIndex, Integer currentNumberOfPieces) {
	 ...
	 */
	public  void logFileFullyDownloaded() {
